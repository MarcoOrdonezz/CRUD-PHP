            ...
            <thead class="thead-inverse">
                ...
                <?php
                    ...
                    while($fila = $resultado->fetch_assoc()){
                        ...
                        echo "<td><a href='editar.php?id=".$fila['id']."'><input type='button' name='btn_agregar' id='btn_agregar' class='btn btn-warning' value='Editar'></a>
                        <a href='eliminar.php?id=".$fila['id']."'><input type='button' name='btn_eliminar' id='btn_eliminar' class='btn btn-danger' value='Eliminar'></a>
                        </td>";
                        echo"</tr>";
                        echo"</tr>";
                    }
